...
const metrics: { key: Metric; label: string; unit: string; colors: { positive: string; negative: string } }[] = [
  { key: 'gas', label: 'Gas', unit: 'm\u00B3', colors: { positive: '#f97316', negative: '#dc2626' } },
  { key: 'electricity', label: 'Elektriciteit', unit: 'kWh', colors: { positive: '#22c55e', negative: '#dc2626' } },
  { key: 'cost', label: 'Kosten', unit: '\u20AC', colors: { positive: '#16a34a', negative: '#dc2626' } },
]
...
<template>
  <div class="chart-card">
    <div class="chart-header">
      ...
      <div class="metric-toggle">
        <button
          ...
          :style="activeMetric === m.key ? { backgroundColor: m.colors.positive, borderColor: m.colors.positive } : {}"
    ...
    <div v-if="!hasBaseline" class="chart-empty">
      Geen meting v&oacute;&oacute;r het fixbezoek beschikbaar. Voeg een jaarrekening in van v&oacute;&oacute;r {{ new Date(props.firstVisitDate).toLocaleDateString('nl-NL') }} om een baseline te bepalen.
    </div>
    ...
    <p v-if="hasBaseline" class="chart-footnote">
      Een negatieve waarde betekent dat het verbruik in die periode hoger was dan de baseline.
    </p>
  </div>
</template>
